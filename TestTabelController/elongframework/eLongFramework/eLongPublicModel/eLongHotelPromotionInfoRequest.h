//
//  eLongHotelPromotionInfoRequest.h
//  ElongClient
//
...
@interface eLongHotelPromotionInfoRequest : NSObject
...
@property (nonatomic,assign) OrderEntranceType fixedOrderEntrance;
@property (nonatomic,assign) OrderPromotionType fixedPromotionType;
- (NSString *) requestString;
- (void) clear;
AS_SINGLETON(eLongHotelPromotionInfoRequest)
@end
