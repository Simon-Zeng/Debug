...
- (BOOL)start
{
	...
	self.service = [[NSNetService alloc] initWithDomain:@"" type:_bonjourType name:@"" port:(int)_port];
    self.service.includesPeerToPeer = YES;
	self.service.delegate = self;
	
	if (_TXTRecord)
	{
		[self.service setTXTRecordData:[NSNetService dataFromTXTRecordDictionary:_TXTRecord]];
	}
