...
@interface eLongFilterView : UIViewController <UITableViewDataSource, UITableViewDelegate> {
...
@optional
- (void)getFilterString:(NSString *)filterStr inFilterView:(eLongFilterView *)filterView;
- (void)selectedIndex:(NSInteger)index inFilterView:(eLongFilterView *)filterView;
- (void)willDismissFilterView:(eLongFilterView *)filterView;
@end
