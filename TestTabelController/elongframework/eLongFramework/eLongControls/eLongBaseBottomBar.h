...
#define BASEBOTTOMBAR_TITLE_COLOR_HIGHLIGHTED [UIColor colorWithRed:68/255.0 green:153/255.0 blue:255/255.0 alpha:1]
#define BASEBOTTOMBAR_TITLE_COLOR_NORMAL  [UIColor whiteColor]

@protocol BaseBottomBarDelegate;
@class BaseBottomBarItem;

@interface eLongBaseBottomBar : UIView
...
@required
- (void)selectedBottomBar:(eLongBaseBottomBar *)bar ItemAtIndex:(NSInteger)index;
...
@property (nonatomic,strong) UIColor  *normalColor;  //自定义label普通状态下颜色
