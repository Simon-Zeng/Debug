...
#define ELONG_FILTERVIEW_COMMON_COLOR_4499FF UIColorFromRGB(0x4499ff)

@interface eLongFilterView ()
...
@implementation eLongFilterView
...
- (id)initWithTitle:(NSString *)title Datas:(NSArray *)datas {
    if (self = [super init]) {
        ...
        [doneBtn setTitleColor:ELONG_FILTERVIEW_COMMON_COLOR_4499FF forState:UIControlStateNormal];
        [doneBtn setTitleColor:ELONG_FILTERVIEW_COMMON_COLOR_4499FF forState:UIControlStateHighlighted];
...
- (void)showInView {
    if (!isShowing) {
        ...
        imageViewLine.backgroundColor = [UIColor colorWithHexStr:@"4499ff"];
