...
@implementation eLongAlertTipView
...
- (void)drawRect:(CGRect)rect {
    ...
    [stringColor setFill];
    [tipString drawInRect:CGRectMake(5, 11, self.frame.size.width - 10, self.frame.size.height - 11) withFont:[UIFont systemFontOfSize:14] lineBreakMode:NSLineBreakByWordWrapping alignment:NSTextAlignmentCenter];
