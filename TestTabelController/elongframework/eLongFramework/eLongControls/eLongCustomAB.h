...
@interface eLongCustomAB : ElongBaseViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UISearchDisplayDelegate, ABPersonViewControllerDelegate> {
@private
