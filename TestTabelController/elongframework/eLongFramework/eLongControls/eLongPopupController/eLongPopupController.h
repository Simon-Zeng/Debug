...
typedef NS_ENUM(NSInteger, eLongPopupStyle) {
    eLongPopupStylePicker = 1,//只针对component为1的pickerView
 ...
 *
 *  @param style为HotelPopupStyleTable时，隐藏titleView的左、右侧按钮
 *
...
- (void)setContents:(NSArray *)contents;//子类化时用以设置contents
