...
@interface eLongCommonSelectView : UIView <UIPickerViewDataSource,UIPickerViewDelegate>{
@private
...
- (void)selectView:(eLongCommonSelectView *)roomSelectView didSelectedNumber:(NSInteger)number;
