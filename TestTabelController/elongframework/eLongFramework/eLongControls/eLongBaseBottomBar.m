...
#import "eLongBaseBottomBar.h"
#import "eLongDefine.h"

@interface eLongBaseBottomBar()
...
@implementation eLongBaseBottomBar
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	if (touch)
    {
        ...
        if (![_cantAccessIndexSet containsObject:[NSNumber numberWithInteger:_selectedIndex]])
        {
...
//定义普通状态下的字体颜色
- (id)initWithTitle:(NSString *)title titleFont:(UIFont *)font normalColor:(UIColor *)normalCo
{
    if (self = [self  initWithTitle:title titleFont:font image:nil highligtedImage:nil]) {
        self.normalColor = normalCo;
        if (self.normalColor) {
