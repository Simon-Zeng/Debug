...
#import "eLongMBSwitch.h"
#import <QuartzCore/QuartzCore.h>


@interface eLongMBSwitch () <UIGestureRecognizerDelegate> {
...
- (void) configure {
    ...
    self.onTintColor = [UIColor colorWithRed:0.9f green:0.34f blue:0.286f alpha:1.00f];
