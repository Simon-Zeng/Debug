...
@interface eLongPhotoPreviewCell () <UIScrollViewDelegate>
...
@implementation eLongPhotoPreviewCell
...
- (void)configCellWithItem:(eLongAssetModel *)item {
...
- (void)_resizeSubviews {
    ...
    self.containerView.center = CGPointMake(self.containerView.center.x, self.frame.size.height/2);
