...
@protocol eLongHttpUploadImageDelegate;

@interface eLongHttpUploadImage : NSObject

@property (nonatomic, assign) id<eLongHttpUploadImageDelegate> delegate;
...
@protocol eLongHttpUploadImageDelegate <NSObject>
